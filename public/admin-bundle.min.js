...
if(this.scrollHeight!=c&&this.refresh(),b>=d)return g!=(a=f[f.length-1])&&this.activate(a);if(g&&b<e[0])return this.activeTarget=null,this.clear();for(a=e.length;a--;)g!=f[a]&&b>=e[a]&&(void 0===e[a+1]||b<e[a+1])&&this.activate(f[a])},b.prototype.activate=function(b){this.activeTarget=b,this.clear();var c=this.selector+'[data-target="'+b+'"],'+this.selector+'[href="'+b+'"]',d=a(c).parents("li").addClass("active");d.parent(".dropdown-menu").length&&(d=d.closest("li.dropdown").addClass("active")),d.trigger("activate.bs.scrollspy")},b.prototype.clear=function(){a(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var d=a.fn.scrollspy;a.fn.scrollspy=c,a.fn.scrollspy.Constructor=b,a.fn.scrollspy.noConflict=function(){return a.fn.scrollspy=d,this},a(window).on("load.bs.scrollspy.data-api",function(){a('[data-spy="scroll"]').each(function(){var b=a(this);c.call(b,b.data())})})}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.tab");e||d.data("bs.tab",e=new c(this)),"string"==typeof b&&e[b]()})}var c=function(b){this.element=a(b)};c.VERSION="3.3.5",c.TRANSITION_DURATION=150,c.prototype.show=function(){var b=this.element,c=b.closest("ul:not(.dropdown-menu)"),d=b.data("target");if(d||(d=b.attr("href"),d=d&&d.replace(/.*(?=#[^\s]*$)/,"")),!b.parent("li").hasClass("active")){var e=c.find(".active:last a"),f=a.Event("hide.bs.tab",{relatedTarget:b[0]}),g=a.Event("show.bs.tab",{relatedTarget:e[0]});if(e.trigger(f),b.trigger(g),!g.isDefaultPrevented()&&!f.isDefaultPrevented()){var h=a(d);this.activate(b.closest("li"),c),this.activate(h,h.parent(),function(){e.trigger({type:"hidden.bs.tab",relatedTarget:b[0]}),b.trigger({type:"shown.bs.tab",relatedTarget:e[0]})})}}},c.prototype.activate=function(b,d,e){function f(){g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),b.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),h?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade"),b.parent(".dropdown-menu").length&&b.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),e&&e()}var g=d.find("> .active"),h=e&&a.support.transition&&(g.length&&g.hasClass("fade")||!!d.find("> .fade").length);g.length&&h?g.one("bsTransitionEnd",f).emulateTransitionEnd(c.TRANSITION_DURATION):f(),g.removeClass("in")};var d=a.fn.tab;a.fn.tab=b,a.fn.tab.Constructor=c,a.fn.tab.noConflict=function(){return a.fn.tab=d,this};var e=function(c){c.preventDefault(),b.call(a(this),"show")};a(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',e).on("click.bs.tab.data-api",'[data-toggle="pill"]',e)}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.affix"),f="object"==typeof b&&b;e||d.data("bs.affix",e=new c(this,f)),"string"==typeof b&&e[b]()})}var c=function(b,d){this.options=a.extend({},c.DEFAULTS,d),this.$target=a(this.options.target).on("scroll.bs.affix.data-api",a.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",a.proxy(this.checkPositionWithEventLoop,this)),this.$element=a(b),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};c.VERSION="3.3.5",c.RESET="affix affix-top affix-bottom",c.DEFAULTS={offset:0,target:window},c.prototype.getState=function(a,b,c,d){var e=this.$target.scrollTop(),f=this.$element.offset(),g=this.$target.height();if(null!=c&&"top"==this.affixed)return c>e?"top":!1;if("bottom"==this.affixed)return null!=c?e+this.unpin<=f.top?!1:"bottom":a-d>=e+g?!1:"bottom";var h=null==this.affixed,i=h?e:f.top,j=h?g:b;return null!=c&&c>=e?"top":null!=d&&i+j>=a-d?"bottom":!1},c.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(c.RESET).addClass("affix");var a=this.$target.scrollTop(),b=this.$element.offset();return this.pinnedOffset=b.top-a},c.prototype.checkPositionWithEventLoop=function(){setTimeout(a.proxy(this.checkPosition,this),1)},c.prototype.checkPosition=function(){if(this.$element.is(":visible")){var b=this.$element.height(),d=this.options.offset,e=d.top,f=d.bottom,g=Math.max(a(document).height(),a(document.body).height());"object"!=typeof d&&(f=e=d),"function"==typeof e&&(e=d.top(this.$element)),"function"==typeof f&&(f=d.bottom(this.$element));var h=this.getState(g,b,e,f);if(this.affixed!=h){null!=this.unpin&&this.$element.css("top","");var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},null!=d.offsetBottom&&(d.offset.bottom=d.offsetBottom),null!=d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery),function(){"use strict";function FastClick(layer,options){function bind(method,context){return function(){return method.apply(context,arguments)}}var oldOnClick;if(options=options||{},this.trackingClick=!1,this.trackingClickStart=0,this.targetElement=null,this.touchStartX=0,this.touchStartY=0,this.lastTouchIdentifier=0,this.touchBoundary=options.touchBoundary||10,this.layer=layer,this.tapDelay=options.tapDelay||200,this.tapTimeout=options.tapTimeout||700,!FastClick.notNeeded(layer)){for(var methods=["onMouse","onClick","onTouchStart","onTouchMove","onTouchEnd","onTouchCancel"],context=this,i=0,l=methods.length;l>i;i++)context[methods[i]]=bind(context[methods[i]],context);deviceIsAndroid&&(layer.addEventListener("mouseover",this.onMouse,!0),layer.addEventListener("mousedown",this.onMouse,!0),layer.addEventListener("mouseup",this.onMouse,!0)),layer.addEventListener("click",this.onClick,!0),layer.addEventListener("touchstart",this.onTouchStart,!1),layer.addEventListener("touchmove",this.onTouchMove,!1),layer.addEventListener("touchend",this.onTouchEnd,!1),layer.addEventListener("touchcancel",this.onTouchCancel,!1),Event.prototype.stopImmediatePropagation||(layer.removeEventListener=function(type,callback,capture){var rmv=Node.prototype.removeEventListener;"click"===type?rmv.call(layer,type,callback.hijacked||callback,capture):rmv.call(layer,type,callback,capture)},layer.addEventListener=function(type,callback,capture){var adv=Node.prototype.addEventListener;"click"===type?adv.call(layer,type,callback.hijacked||(callback.hijacked=function(event){event.propagationStopped||callback(event)}),capture):adv.call(layer,type,callback,capture)}),"function"==typeof layer.onclick&&(oldOnClick=layer.onclick,layer.addEventListener("click",function(event){oldOnClick(event)},!1),layer.onclick=null)}}var deviceIsWindowsPhone=navigator.userAgent.indexOf("Windows Phone")>=0,deviceIsAndroid=navigator.userAgent.indexOf("Android")>0&&!deviceIsWindowsPhone,deviceIsIOS=/iP(ad|hone|od)/.test(navigator.userAgent)&&!deviceIsWindowsPhone,deviceIsIOS4=deviceIsIOS&&/OS 4_\d(_\d)?/.test(navigator.userAgent),deviceIsIOSWithBadTarget=deviceIsIOS&&/OS [6-7]_\d/.test(navigator.userAgent),deviceIsBlackBerry10=navigator.userAgent.indexOf("BB10")>0;FastClick.prototype.needsClick=function(target){switch(target.nodeName.toLowerCase()){case"button":case"select":case"textarea":if(target.disabled)return!0;break;case"input":if(deviceIsIOS&&"file"===target.type||target.disabled)return!0;break;case"label":case"iframe":case"video":return!0}return/\bneedsclick\b/.test(target.className)},FastClick.prototype.needsFocus=function(target){switch(target.nodeName.toLowerCase()){case"textarea":return!0;case"select":return!deviceIsAndroid;case"input":switch(target.type){case"button":case"checkbox":case"file":case"image":case"radio":case"submit":return!1}return!target.disabled&&!target.readOnly;default:return/\bneedsfocus\b/.test(target.className)}},FastClick.prototype.sendClick=function(targetElement,event){var clickEvent,touch;document.activeElement&&document.activeElement!==targetElement&&document.activeElement.blur(),touch=event.changedTouches[0],clickEvent=document.createEvent("MouseEvents"),clickEvent.initMouseEvent(this.determineEventType(targetElement),!0,!0,window,1,touch.screenX,touch.screenY,touch.clientX,touch.clientY,!1,!1,!1,!1,0,null),clickEvent.forwardedTouchEvent=!0,targetElement.dispatchEvent(clickEvent)},FastClick.prototype.determineEventType=function(targetElement){return deviceIsAndroid&&"select"===targetElement.tagName.toLowerCase()?"mousedown":"click"},FastClick.prototype.focus=function(targetElement){var length;deviceIsIOS&&targetElement.setSelectionRange&&0!==targetElement.type.indexOf("date")&&"time"!==targetElement.type&&"month"!==targetElement.type?(length=targetElement.value.length,targetElement.setSelectionRange(length,length)):targetElement.focus()},FastClick.prototype.updateScrollParent=function(targetElement){var scrollParent,parentElement;if(scrollParent=targetElement.fastClickScrollParent,!scrollParent||!scrollParent.contains(targetElement)){parentElement=targetElement;do{if(parentElement.scrollHeight>parentElement.offsetHeight){scrollParent=parentElement,targetElement.fastClickScrollParent=parentElement;break}parentElement=parentElement.parentElement}while(parentElement)}scrollParent&&(scrollParent.fastClickLastScrollTop=scrollParent.scrollTop)},FastClick.prototype.getTargetElementFromEventTarget=function(eventTarget){return eventTarget.nodeType===Node.TEXT_NODE?eventTarget.parentNode:eventTarget},FastClick.prototype.onTouchStart=function(event){var targetElement,touch,selection;if(event.targetTouches.length>1)return!0;if(targetElement=this.getTargetElementFromEventTarget(event.target),touch=event.targetTouches[0],deviceIsIOS){if(selection=window.getSelection(),selection.rangeCount&&!selection.isCollapsed)return!0;if(!deviceIsIOS4){if(touch.identifier&&touch.identifier===this.lastTouchIdentifier)return event.preventDefault(),!1;this.lastTouchIdentifier=touch.identifier,this.updateScrollParent(targetElement)}}return this.trackingClick=!0,this.trackingClickStart=event.timeStamp,this.targetElement=targetElement,this.touchStartX=touch.pageX,this.touchStartY=touch.pageY,event.timeStamp-this.lastClickTime<this.tapDelay&&event.preventDefault(),!0},FastClick.prototype.touchHasMoved=function(event){var touch=event.changedTouches[0],boundary=this.touchBoundary;return Math.abs(touch.pageX-this.touchStartX)>boundary||Math.abs(touch.pageY-this.touchStartY)>boundary?!0:!1},FastClick.prototype.onTouchMove=function(event){return this.trackingClick?((this.targetElement!==this.getTargetElementFromEventTarget(event.target)||this.touchHasMoved(event))&&(this.trackingClick=!1,this.targetElement=null),!0):!0},FastClick.prototype.findControl=function(labelElement){return void 0!==labelElement.control?labelElement.control:labelElement.htmlFor?document.getElementById(labelElement.htmlFor):labelElement.querySelector("button, input:not([type=hidden]), keygen, meter, output, progress, select, textarea")},FastClick.prototype.onTouchEnd=function(event){var forElement,trackingClickStart,targetTagName,scrollParent,touch,targetElement=this.targetElement;if(!this.trackingClick)return!0;if(event.timeStamp-this.lastClickTime<this.tapDelay)return this.cancelNextClick=!0,!0;if(event.timeStamp-this.trackingClickStart>this.tapTimeout)return!0;if(this.cancelNextClick=!1,this.lastClickTime=event.timeStamp,trackingClickStart=this.trackingClickStart,this.trackingClick=!1,this.trackingClickStart=0,deviceIsIOSWithBadTarget&&(touch=event.changedTouches[0],targetElement=document.elementFromPoint(touch.pageX-window.pageXOffset,touch.pageY-window.pageYOffset)||targetElement,targetElement.fastClickScrollParent=this.targetElement.fastClickScrollParent),targetTagName=targetElement.tagName.toLowerCase(),"label"===targetTagName){if(forElement=this.findControl(targetElement)){if(this.focus(targetElement),deviceIsAndroid)return!1;targetElement=forElement}}else if(this.needsFocus(targetElement))return event.timeStamp-trackingClickStart>100||deviceIsIOS&&window.top!==window&&"input"===targetTagName?(this.targetElement=null,!1):(this.focus(targetElement),this.sendClick(targetElement,event),deviceIsIOS&&"select"===targetTagName||(this.targetElement=null,event.preventDefault()),!1);return deviceIsIOS&&!deviceIsIOS4&&(scrollParent=targetElement.fastClickScrollParent,scrollParent&&scrollParent.fastClickLastScrollTop!==scrollParent.scrollTop)?!0:(this.needsClick(targetElement)||(event.preventDefault(),this.sendClick(targetElement,event)),!1)},FastClick.prototype.onTouchCancel=function(){this.trackingClick=!1,this.targetElement=null},FastClick.prototype.onMouse=function(event){return this.targetElement?event.forwardedTouchEvent?!0:event.cancelable&&(!this.needsClick(this.targetElement)||this.cancelNextClick)?(event.stopImmediatePropagation?event.stopImmediatePropagation():event.propagationStopped=!0,event.stopPropagation(),event.preventDefault(),!1):!0:!0},FastClick.prototype.onClick=function(event){var permitted;return this.trackingClick?(this.targetElement=null,this.trackingClick=!1,!0):"submit"===event.target.type&&0===event.detail?!0:(permitted=this.onMouse(event),permitted||(this.targetElement=null),permitted)},FastClick.prototype.destroy=function(){var layer=this.layer;deviceIsAndroid&&(layer.removeEventListener("mouseover",this.onMouse,!0),layer.removeEventListener("mousedown",this.onMouse,!0),layer.removeEventListener("mouseup",this.onMouse,!0)),layer.removeEventListener("click",this.onClick,!0),layer.removeEventListener("touchstart",this.onTouchStart,!1),layer.removeEventListener("touchmove",this.onTouchMove,!1),layer.removeEventListener("touchend",this.onTouchEnd,!1),layer.removeEventListener("touchcancel",this.onTouchCancel,!1)},FastClick.notNeeded=function(layer){var metaViewport,chromeVersion,blackberryVersion,firefoxVersion;if("undefined"==typeof window.ontouchstart)return!0;if(chromeVersion=+(/Chrome\/([0-9]+)/.exec(navigator.userAgent)||[,0])[1]){if(!deviceIsAndroid)return!0;if(metaViewport=document.querySelector("meta[name=viewport]")){if(-1!==metaViewport.content.indexOf("user-scalable=no"))return!0;if(chromeVersion>31&&document.documentElement.scrollWidth<=window.outerWidth)return!0}}if(deviceIsBlackBerry10&&(blackberryVersion=navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/),blackberryVersion[1]>=10&&blackberryVersion[2]>=3&&(metaViewport=document.querySelector("meta[name=viewport]")))){if(-1!==metaViewport.content.indexOf("user-scalable=no"))return!0;if(document.documentElement.scrollWidth<=window.outerWidth)return!0}return"none"===layer.style.msTouchAction||"manipulation"===layer.style.touchAction?!0:(firefoxVersion=+(/Firefox\/([0-9]+)/.exec(navigator.userAgent)||[,0])[1],firefoxVersion>=27&&(metaViewport=document.querySelector("meta[name=viewport]"),metaViewport&&(-1!==metaViewport.content.indexOf("user-scalable=no")||document.documentElement.scrollWidth<=window.outerWidth))?!0:"none"===layer.style.touchAction||"manipulation"===layer.style.touchAction?!0:!1)},FastClick.attach=function(layer,options){return new FastClick(layer,options)},"function"==typeof define&&"object"==typeof define.amd&&define.amd?define(function(){return FastClick}):"undefined"!=typeof module&&module.exports?(module.exports=FastClick.attach,module.exports.FastClick=FastClick):window.FastClick=FastClick}(),function(root,factory){"object"==typeof exports&&"object"==typeof module?module.exports=factory():"function"==typeof define&&define.amd?define(factory):"object"==typeof exports?exports.Flux=factory():root.Flux=factory()}(this,function(){return function(modules){function __webpack_require__(moduleId){if(installedModules[moduleId])return installedModules[moduleId].exports;var module=installedModules[moduleId]={exports:{},id:moduleId,loaded:!1};return modules[moduleId].call(module.exports,module,module.exports,__webpack_require__),module.loaded=!0,module.exports}var installedModules={};return __webpack_require__.m=modules,__webpack_require__.c=installedModules,__webpack_require__.p="",__webpack_require__(0)}([function(module,exports,__webpack_require__){"use strict";module.exports.Dispatcher=__webpack_require__(1)},function(module,exports,__webpack_require__){"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}exports.__esModule=!0;var invariant=__webpack_require__(2),_prefix="ID_",Dispatcher=function(){function Dispatcher(){_classCallCheck(this,Dispatcher),this._callbacks={},this._isDispatching=!1,this._isHandled={},this._isPending={},this._lastID=1}return Dispatcher.prototype.register=function(callback){var id=_prefix+this._lastID++;return this._callbacks[id]=callback,id},Dispatcher.prototype.unregister=function(id){this._callbacks[id]?void 0:invariant(!1,"Dispatcher.unregister(...): `%s` does not map to a registered callback.",id),delete this._callbacks[id]},Dispatcher.prototype.waitFor=function(ids){this._isDispatching?void 0:invariant(!1,"Dispatcher.waitFor(...): Must be invoked while dispatching.");for(var ii=0;ii<ids.length;ii++){var id=ids[ii];this._isPending[id]?this._isHandled[id]?void 0:invariant(!1,"Dispatcher.waitFor(...): Circular dependency detected while waiting for `%s`.",id):(this._callbacks[id]?void 0:invariant(!1,"Dispatcher.waitFor(...): `%s` does not map to a registered callback.",id),this._invokeCallback(id))}},Dispatcher.prototype.dispatch=function(payload){this._isDispatching?invariant(!1,"Dispatch.dispatch(...): Cannot dispatch in the middle of a dispatch."):void 0,this._startDispatching(payload);try{for(var id in this._callbacks)this._isPending[id]||this._invokeCallback(id)}finally{this._stopDispatching()}},Dispatcher.prototype.isDispatching=function(){return this._isDispatching},Dispatcher.prototype._invokeCallback=function(id){this._isPending[id]=!0,this._callbacks[id](this._pendingPayload),this._isHandled[id]=!0},Dispatcher.prototype._startDispatching=function(payload){for(var id in this._callbacks)this._isPending[id]=!1,this._isHandled[id]=!1;this._pendingPayload=payload,this._isDispatching=!0},Dispatcher.prototype._stopDispatching=function(){delete this._pendingPayload,this._isDispatching=!1},Dispatcher}();module.exports=Dispatcher},function(module,exports,__webpack_require__){"use strict";var invariant=function(condition,format,a,b,c,d,e,f){if(void 0===format)throw new Error("invariant requires an error message argument");if(!condition){var error;if(void 0===format)error=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var args=[a,b,c,d,e,f],argIndex=0;error=new Error("Invariant Violation: "+format.replace(/%s/g,function(){return args[argIndex++]}))}throw error.framesToPop=1,error}};module.exports=invariant}])});var MicroEvent=function(){};MicroEvent.prototype={bind:function(event,fct){this._events=this._events||{},this._events[event]=this._events[event]||[],this._events[event].push(fct)},unbind:function(event,fct){this._events=this._events||{},event in this._events!=!1&&this._events[event].splice(this._events[event].indexOf(fct),1)},trigger:function(event){if(this._events=this._events||{},event in this._events!=!1)for(var i=0;i<this._events[event].length;i++)this._events[event][i].apply(this,Array.prototype.slice.call(arguments,1))}},MicroEvent.mixin=function(destObject){for(var props=["bind","unbind","trigger"],i=0;i<props.length;i++)"function"==typeof destObject?destObject.prototype[props[i]]=MicroEvent.prototype[props[i]]:destObject[props[i]]=MicroEvent.prototype[props[i]];return destObject},"undefined"!=typeof module&&"exports"in module&&(module.exports=MicroEvent);var React=require("react"),ReactRouter=require("react-router"),Dispatcher=require("flux").Dispatcher,AppDispatcher=new Dispatcher,HomeActions={selectHomeFile:function(file,slug){AppDispatcher.dispatch({eventName:"selectHomeFile",file:file,slug:slug})},submitHome:function(){AppDispatcher.dispatch({eventName:"submitHome"})}},AboutActions={loadGallery:function(){AppDispatcher.dispatch({eventName:"loadGallery"})},saveGallery:function(){AppDispatcher.dispatch({eventName:"saveGallery"})},changeFile:function(file,slug){AppDispatcher.dispatch({eventName:"changeFile",file:file,slug:slug})}},MenuActions={loadMenus:function(){AppDispatcher.dispatch({eventName:"loadMenus"})},loadEditMenuForm:function(slug){AppDispatcher.dispatch({eventName:"loadEditMenuForm",slug:slug})},deleteMenu:function(id){AppDispatcher.dispatch({eventName:"deleteMenu",id:id})},changeAddMenuTitle:function(value){AppDispatcher.dispatch({eventName:"changeAddMenuTitle",value:value})},changeAddMenuDescription:function(value){AppDispatcher.dispatch({eventName:"changeAddMenuDescription",value:value})},addMenu:function(){AppDispatcher.dispatch({eventName:"addMenu"})},changeEditMenuTitle:function(value){AppDispatcher.dispatch({eventName:"changeEditMenuTitle",value:value})},changeEditMenuDescription:function(value){AppDispatcher.dispatch({eventName:"changeEditMenuDescription",value:value})},submitEditForm:function(){AppDispatcher.dispatch({eventName:"submitEditForm"})}},MenuItemActions={loadMenuItems:function(menuSlug){AppDispatcher.dispatch({eventName:"loadMenuItems",menuSlug:menuSlug})},deleteMenuItem:function(id){AppDispatcher.dispatch({eventName:"deleteMenuItem",id:id})},addMenuItem:function(){AppDispatcher.dispatch({eventName:"addMenuItem"})},changeAddMenuItemTitle:function(value){AppDispatcher.dispatch({eventName:"changeAddMenuItemTitle",value:value})},changeAddMenuItemDescription:function(value){AppDispatcher.dispatch({eventName:"changeAddMenuItemDescription",value:value})},changeAddMenuItemPrice:function(value){AppDispatcher.dispatch({eventName:"changeAddMenuItemPrice",value:value})}},ContactActions={saveContact:function(){AppDispatcher.dispatch({eventName:"saveContact"})},loadContact:function(){AppDispatcher.dispatch({eventName:"loadContact"})},changeEmail:function(value){AppDispatcher.dispatch({eventName:"changeEmail",value:value})},changePhone:function(value){AppDispatcher.dispatch({eventName:"changePhone",value:value})},changeMonday:function(value){AppDispatcher.dispatch({eventName:"changeMonday",value:value})},changeTuesday:function(value){AppDispatcher.dispatch({eventName:"changeTuesday",value:value})},changeWednesday:function(value){AppDispatcher.dispatch({eventName:"changeWednesday",value:value})},changeThursday:function(value){AppDispatcher.dispatch({eventName:"changeThursday",value:value})},changeFriday:function(value){AppDispatcher.dispatch({eventName:"changeFriday",value:value})},changeSaturday:function(value){AppDispatcher.dispatch({eventName:"changeSaturday",value:value})},changeSunday:function(value){AppDispatcher.dispatch({eventName:"changeSunday",value:value})},changeAddress1:function(value){AppDispatcher.dispatch({eventName:"changeAddress1",value:value})},changeAddress2:function(value){AppDispatcher.dispatch({eventName:"changeAddress2",value:value})},changeAddress3:function(value){AppDispatcher.dispatch({eventName:"changeAddress3",value:value})},changeAddress4:function(value){AppDispatcher.dispatch({eventName:"changeAddress4",value:value})}},AboutStore={gallery:{galleryOne:{},galleryTwo:{},galleryThree:{},galleryFour:{},galleryFive:{},gallerySix:{},gallerySeven:{},galleryEight:{},button:{value:"Upload Images",disabled:!0}},loadGallery:function(){},getGallery:function(){return this.gallery},saveGallery:function(){var data=new FormData;this.gallery.button.value="Uploading...",this.gallery.button.disabled=!0,this.trigger("change");var self=this;$.each(this.gallery,function(key,value){data.append(key,value)}),$.ajax({url:"/admin/api/about",type:"POST",data:data,cache:!1,dataType:"json",processData:!1,contentType:!1}).done(function(data){console.log("Success, clearing inputs"),self.clearGallery(),location.reload()}).fail(function(data){console.log("Error saving gallery"),console.log(data)}).always(function(data){self.trigger("change")})},changeFile:function(page,slug){this.gallery[slug]=page,this.gallery.button.disabled=!1},clearGallery:function(){this.gallery={button:{value:"Upload Images",disabled:!0}}}};MicroEvent.mixin(AboutStore),AppDispatcher.register(function(payload){switch(payload.eventName){case"loadGallery":AboutStore.loadGallery();break;case"saveGallery":AboutStore.saveGallery();break;case"changeFile":AboutStore.changeFile(payload.file,payload.slug),AboutStore.trigger("change")}});var ContactStore={contact:{email:"",phone:"",address:{line1:"",line2:"",line3:"",line4:""},hours:{monday:"",tuesday:"",wednesday:"",thursday:"",friday:"",saturday:"",sunday:""},response:{saved:!1,sent:!1}},loadContact:function(){var self=this;$.get("/api/contact",function(data){self.contact=data.data,self.trigger("change")}).fail(function(data){console.log("Failed to load database.")})},getContact:function(){return this.contact},saveChanges:function(){var self=this;$.ajax({url:"/admin/api/contact",type:"PUT",data:this.contact,success:function(data){self.contact.response={saved:!0,sent:!0}}}).fail(function(data){self.contact.response={saved:!1,sent:!0}}).always(function(data){self.trigger("change")})},changeEmail:function(value){this.contact.email=value},changePhone:function(value){this.contact.phone=value},changeAddress1:function(value){this.contact.address.line1=value},changeAddress2:function(value){this.contact.address.line2=value},changeAddress3:function(value){this.contact.address.line3=value},changeAddress4:function(value){this.contact.address.line4=value},changeMonday:function(value){this.contact.hours.monday=value},changeTuesday:function(value){this.contact.hours.tuesday=value},changeWednesday:function(value){this.contact.hours.wednesday=value},changeThursday:function(value){this.contact.hours.thursday=value},changeFriday:function(value){this.contact.hours.friday=value},changeSaturday:function(value){this.contact.hours.saturday=value},changeSunday:function(value){this.contact.hours.sunday=value}};MicroEvent.mixin(ContactStore),AppDispatcher.register(function(payload){switch(payload.eventName){case"saveContact":ContactStore.saveChanges();break;case"loadContact":ContactStore.loadContact();break;case"changeEmail":ContactStore.changeEmail(payload.value),ContactStore.trigger("change");break;case"changePhone":ContactStore.changePhone(payload.value),ContactStore.trigger("change");break;case"changeAddress1":ContactStore.changeAddress1(payload.value),ContactStore.trigger("change");break;case"changeAddress2":ContactStore.changeAddress2(payload.value),ContactStore.trigger("change");break;case"changeAddress3":ContactStore.changeAddress3(payload.value),ContactStore.trigger("change");break;case"changeAddress4":ContactStore.changeAddress4(payload.value),ContactStore.trigger("change");break;case"changeMonday":ContactStore.changeMonday(payload.value),ContactStore.trigger("change");break;case"changeTuesday":ContactStore.changeTuesday(payload.value),ContactStore.trigger("change");break;case"changeWednesday":ContactStore.changeWednesday(payload.value),ContactStore.trigger("change");break;case"changeThursday":ContactStore.changeThursday(payload.value),ContactStore.trigger("change");break;case"changeFriday":ContactStore.changeFriday(payload.value),ContactStore.trigger("change");break;case"changeSaturday":ContactStore.changeSaturday(payload.value),ContactStore.trigger("change");break;case"changeSunday":ContactStore.changeSunday(payload.value),ContactStore.trigger("change")}});var HomeStore={home:{},initHome:function(){return this.home={files:{featuredImageOne:{},featuredImageTwo:{},featuredImageThree:{},featuredImageFour:{}},uploaded:!1,uploading:!1,error:!1},this.home},getHome:function(){return this.home},selectFile:function(page,slug){this.home.files[slug]=page},submitForm:function(){this.home.error=!1,this.home.uploaded=!1;var data=new FormData,self=this;$.each(this.home.files,function(key,value){data.append(key,value)}),self.home.uploading=!0,$.ajax({url:"admin/api/home",type:"POST",data:data,cache:!1,dataType:"json",processData:!1,contentType:!1}).done(function(data){console.log("Success, clearing inputs"),self.initHome(),self.home.uploaded=!0,location.reload()}).fail(function(data){console.log("Error submitting form"),console.log(data),self.home.error=!0}).always(function(data){self.home.uploading=!1,HomeStore.trigger("change")})}};MicroEvent.mixin(HomeStore),AppDispatcher.register(function(payload){switch(payload.eventName){case"selectHomeFile":HomeStore.selectFile(payload.file,payload.slug),HomeStore.trigger("change");break;case"submitHome":HomeStore.submitForm(),HomeStore.trigger("change")}});var MenuItemStore={addMenuItemForm:{title:"",description:"",price:""},menuItems:[{id:0,title:"",description:"",price:""}],menuSlug:"",loadMenuItems:function(menuSlug){this.menuSlug=menuSlug,$.get("/api/menu/"+menuSlug+"/items",function(data){this.menuItems=data.menuItems,this.trigger("change")}.bind(this))},getMenuItems:function(){return this.menuItems},getMenuItemForm:function(){return this.addMenuItemForm},deleteMenuItem:function(id){var self=this;$.ajax({url:"/admin/api/menu/"+this.menuSlug+"/"+id,type:"DELETE",success:function(data){self.loadMenuItems(self.menuSlug)}}).fail(function(data){console.log("Delete failed")}).always(function(data){self.trigger("change")})},addMenuItem:function(){var self=this;$.ajax({url:"/admin/api/menu/"+this.menuSlug,type:"POST",data:this.addMenuItemForm,success:function(data){self.loadMenuItems(self.menuSlug),self.clearAddMenuItemForm()}}).fail(function(data){}).always(function(data){self.trigger("change")})},changeAddMenuItemTitle:function(title){this.addMenuItemForm.title=title},changeAddMenuItemDescription:function(description){this.addMenuItemForm.description=description},changeAddMenuItemPrice:function(price){this.addMenuItemForm.price=price},clearAddMenuItemForm:function(){this.addMenuItemForm={title:"",description:"",price:""}}};MicroEvent.mixin(MenuItemStore),AppDispatcher.register(function(payload){switch(payload.eventName){case"loadMenuItems":MenuItemStore.loadMenuItems(payload.menuSlug);break;case"deleteMenuItem":MenuItemStore.deleteMenuItem(payload.id);break;case"addMenuItem":MenuItemStore.addMenuItem();break;case"changeAddMenuItemTitle":MenuItemStore.changeAddMenuItemTitle(payload.value),MenuItemStore.trigger("change");break;case"changeAddMenuItemDescription":MenuItemStore.changeAddMenuItemDescription(payload.value),MenuItemStore.trigger("change");break;case"changeAddMenuItemPrice":MenuItemStore.changeAddMenuItemPrice(payload.value),MenuItemStore.trigger("change")}});var MenuStore={menus:[{id:"",title:"",description:"",slug:""}],addMenuForm:{title:"",description:"",menuAdded:!1,menuAddedError:!1},editMenuForm:{id:"",title:"",description:""},getMenus:function(){return this.menus},loadMenus:function(){$.get("/api/menu",function(data){this.menus=data.menus,this.trigger("change")}.bind(this))},loadEditMenuForm:function(slug){var self=this;$.get("/api/menu/"+slug,function(data){self.editMenuForm=data.menu,self.trigger("change")}).fail(function(data){console.log("fail")})},addMenu:function(){var self=this;$.post("/admin/api/menu",{menuTitle:this.addMenuForm.title,menuDescription:this.addMenuForm.description},function(data){self.clearAddMenuForm(),self.loadMenus()},"json").fail(function(data){self.addMenu.menuAddedError=!0,self.trigger("change")})},changeAddMenuTitle:function(value){this.addMenuForm.title=value},changeAddMenuDescription:function(value){this.addMenuForm.description=value},changeEditMenuTitle:function(value){this.editMenuForm.title=value},changeEditMenuDescription:function(value){this.editMenuForm.description=value},getAddMenuForm:function(){return this.addMenuForm},getEditMenuForm:function(){return this.editMenuForm},clearAddMenuForm:function(){
this.addMenuForm={title:"",description:"",menuAdded:!0,menuAddedError:!1}},deleteMenu:function(id){var self=this;$.ajax({url:"/admin/api/menu/"+id,type:"DELETE",success:function(data){self.loadMenus()}}).fail(function(data){console.log("Delete failed")}).always(function(data){self.trigger("change")})},submitEditForm:function(){var self=this;$.ajax({url:"/admin/api/menu/"+this.editMenuForm.id,type:"PUT",data:this.editMenuForm,success:function(data){self.editMenuForm=data.result,self.loadEditMenuForm(self.editMenuForm.slug),window.location="/admin/menus"}}).fail(function(data){console.log("Update failed")}).always(function(data){self.trigger("change")})}};MicroEvent.mixin(MenuStore),AppDispatcher.register(function(payload){switch(payload.eventName){case"loadMenus":MenuStore.loadMenus();break;case"loadEditMenuForm":MenuStore.loadEditMenuForm(payload.slug);break;case"deleteMenu":MenuStore.deleteMenu(payload.id);break;case"addMenu":MenuStore.addMenu(),MenuStore.trigger("change");break;case"changeAddMenuTitle":MenuStore.changeAddMenuTitle(payload.value),MenuStore.trigger("change");break;case"changeAddMenuDescription":MenuStore.changeAddMenuDescription(payload.value),MenuStore.trigger("change");break;case"changeEditMenuTitle":MenuStore.changeEditMenuTitle(payload.value),MenuStore.trigger("change");break;case"changeEditMenuDescription":MenuStore.changeEditMenuDescription(payload.value),MenuStore.trigger("change");break;case"submitEditForm":MenuStore.submitEditForm()}});var About=React.createClass({displayName:"About",render:function(){return React.createElement("div",{className:"about container"},React.createElement(GalleryInput,null))}}),GalleryInput=React.createClass({displayName:"GalleryInput",getInitialState:function(){return{gallery:AboutStore.getGallery()}},componentDidMount:function(){AboutStore.bind("change",this.onChange)},componentWillUnmount:function(){AboutStore.unbind("change",this.onChange)},onChange:function(){this.setState({gallery:AboutStore.getGallery()})},fileChange:function(e){AboutActions.changeFile(e.target.files[0],e.target.id)},saveGallery:function(){AboutActions.saveGallery()},render:function(){return React.createElement("div",{className:"gallery-input panel panel-default"},React.createElement("h2",{className:"panel-heading"},"Gallery Input"),React.createElement("div",{className:"panel-body"},React.createElement("div",{className:"gallery-preview"},React.createElement(ImageInput,{slug:"galleryOne",fileChange:this.fileChange,title:"Gallery Image One"}),React.createElement(ImageInput,{slug:"galleryTwo",fileChange:this.fileChange,title:"Gallery Image Two"}),React.createElement(ImageInput,{slug:"galleryThree",fileChange:this.fileChange,title:"Gallery Image Three"}),React.createElement(ImageInput,{slug:"galleryFour",fileChange:this.fileChange,title:"Gallery Image Four"}),React.createElement(ImageInput,{slug:"galleryFive",fileChange:this.fileChange,title:"Gallery Image Five"}),React.createElement(ImageInput,{slug:"gallerySix",fileChange:this.fileChange,title:"Gallery Image Six"}),React.createElement(ImageInput,{slug:"gallerySeven",fileChange:this.fileChange,title:"Gallery Image Seven"}),React.createElement(ImageInput,{slug:"galleryEight",fileChange:this.fileChange,title:"Gallery Image Eight"})),React.createElement("button",{className:"btn btn-default",onClick:this.saveGallery,disabled:0===this.state.gallery.length||this.state.gallery.button.disabled},this.state.gallery.button.value)))}}),Contact=React.createClass({displayName:"Contact",getInitialState:function(){return ContactStore.getContact()},componentDidMount:function(){ContactStore.bind("change",this.onChange),ContactActions.loadContact()},componentWillUnmount:function(){ContactStore.unbind("change",this.onChange)},onChange:function(){this.setState(ContactStore.getContact())},onSubmit:function(e){e.preventDefault(),ContactActions.saveContact()},changeEmail:function(e){ContactActions.changeEmail(e.target.value)},changePhone:function(e){ContactActions.changePhone(e.target.value)},changeAddress1:function(e){ContactActions.changeAddress1(e.target.value)},changeAddress2:function(e){ContactActions.changeAddress2(e.target.value)},changeAddress3:function(e){ContactActions.changeAddress3(e.target.value)},changeAddress4:function(e){ContactActions.changeAddress4(e.target.value)},changeMonday:function(e){ContactActions.changeMonday(e.target.value)},changeTuesday:function(e){ContactActions.changeTuesday(e.target.value)},changeWednesday:function(e){ContactActions.changeWednesday(e.target.value)},changeThursday:function(e){ContactActions.changeThursday(e.target.value)},changeFriday:function(e){ContactActions.changeFriday(e.target.value)},changeSaturday:function(e){ContactActions.changeSaturday(e.target.value)},changeSunday:function(e){ContactActions.changeSunday(e.target.value)},render:function(){return React.createElement("div",{className:"container"},React.createElement("div",{className:"contact panel panel-default"},React.createElement("h2",{className:"panel-heading"},"Contact Us"),React.createElement("form",{noValidate:!0,className:"panel-body",onSubmit:this.onSubmit},React.createElement("div",{className:"form-group"},React.createElement("label",{className:"control-label",htmlFor:"email"},"Email: "),React.createElement("input",{type:"email",id:"email",className:"form-control",value:this.state.email,onChange:this.changeEmail})),React.createElement("div",{className:"form-group"},React.createElement("label",{className:"control-label",htmlFor:"phone"},"Phone: "),React.createElement("input",{type:"text",id:"phone",className:"form-control",value:this.state.phone,onChange:this.changePhone})),React.createElement("div",{className:"form-group"},React.createElement("label",{className:"control-label",htmlFor:"address1"},"Address: "),React.createElement("input",{type:"text",id:"address1",className:"form-control",value:this.state.address.line1,onChange:this.changeAddress1}),React.createElement("input",{type:"text",id:"address2",className:"form-control",value:this.state.address.line2,onChange:this.changeAddress2}),React.createElement("input",{type:"text",id:"address3",className:"form-control",value:this.state.address.line3,onChange:this.changeAddress3}),React.createElement("input",{type:"text",id:"address4",className:"form-control",value:this.state.address.line4,onChange:this.changeAddress4})),React.createElement("h3",null,"Opening Hours"),React.createElement("div",{className:"form-group"},React.createElement("label",{className:"control-label",htmlFor:"monday"},"Monday: "),React.createElement("input",{type:"text",id:"monday",className:"form-control",value:this.state.hours.monday,onChange:this.changeMonday}),React.createElement("label",{className:"control-label",htmlFor:"tuesday"},"Tuesday: "),React.createElement("input",{type:"text",id:"tuesday",className:"form-control",value:this.state.hours.tuesday,onChange:this.changeTuesday}),React.createElement("label",{className:"control-label",htmlFor:"wednesday"},"Wednesday: "),React.createElement("input",{type:"text",id:"wednesday",className:"form-control",value:this.state.hours.wednesday,onChange:this.changeWednesday}),React.createElement("label",{className:"control-label",htmlFor:"thursday"},"Thursday: "),React.createElement("input",{type:"text",id:"thursday",className:"form-control",value:this.state.hours.thursday,onChange:this.changeThursday}),React.createElement("label",{className:"control-label",htmlFor:"friday"},"Friday: "),React.createElement("input",{type:"text",id:"friday",className:"form-control",value:this.state.hours.friday,onChange:this.changeFriday}),React.createElement("label",{className:"control-label",htmlFor:"saturday"},"Saturday: "),React.createElement("input",{type:"text",id:"saturday",className:"form-control",value:this.state.hours.saturday,onChange:this.changeSaturday}),React.createElement("label",{className:"control-label",htmlFor:"sunday"},"Sunday: "),React.createElement("input",{type:"text",id:"sunday",className:"form-control",value:this.state.hours.sunday,onChange:this.changeSunday})),React.createElement("input",{type:"submit",value:"Save changes",className:"btn btn-default"}),React.createElement("div",{className:this.state.response.sent?"response-messages":"hidden"},React.createElement("span",{className:this.state.response.saved?"text-success":"hidden"},"Changes were saved!"),React.createElement("span",{className:this.state.response.saved?"hidden":"text-danger"},"Changes were not saved! Try refresh and try again")))))}}),Home=React.createClass({displayName:"Home",getInitialState:function(){return HomeStore.initHome()},componentDidMount:function(){HomeStore.bind("change",this.onChange)},componentWillUnmount:function(){HomeStore.unbind("change",this.onChange)},fileChange:function(e){HomeActions.selectHomeFile(e.target.files[0],e.target.id)},onChange:function(){this.setState(HomeStore.getHome())},onSubmit:function(e){e.preventDefault(),HomeActions.submitHome()},render:function(){return React.createElement("div",{className:"home container"},React.createElement("form",{noValidate:!0,encType:"multipart/form-data",onSubmit:this.onSubmit},React.createElement("div",{className:"row"},React.createElement(ImageInput,{slug:"homeFeaturedOne",fileChange:this.fileChange,title:"Featured Image One"}),React.createElement(ImageInput,{slug:"homeFeaturedTwo",fileChange:this.fileChange,title:"Featured Image Two"}),React.createElement(ImageInput,{slug:"homeFeaturedThree",fileChange:this.fileChange,title:"Featured Image Three"}),React.createElement(ImageInput,{slug:"homeFeaturedFour",fileChange:this.fileChange,title:"Featured Image Four"})),React.createElement("input",{type:"submit",className:"btn btn-default",disabled:this.state.uploading,value:"Submit"}),React.createElement("span",{className:"response-messages"},React.createElement("span",{className:this.state.uploading?"text-warning":"hidden"},"Uploading and resizing images... (This may take a minute or two)"),React.createElement("span",{className:this.state.uploaded?"text-success":"hidden"},"Changes have been saved!"),React.createElement("span",{className:this.state.error?"text-danger":"hidden"},"There was an error uploading the images. Please try again."))))}}),Header=React.createClass({displayName:"Header",render:function(){return React.createElement("nav",{className:"navbar navbar-default col-xs-12"},React.createElement("ul",{className:"nav navbar-nav col-xs-12 row"},React.createElement("li",{className:"col-xs-12 col-sm-3 col-md-2"},React.createElement("a",{href:"/",className:"navbar-brand"},"Back to site")),React.createElement("li",null,React.createElement(Link,{to:"home"},"Home")),React.createElement("li",null,React.createElement(Link,{to:"about"},"About")),React.createElement("li",null,React.createElement(Link,{to:"menus"},"Menus")),React.createElement("li",null,React.createElement(Link,{to:"contact"},"Contact")),React.createElement("li",null,React.createElement("a",{href:"/auth/logout"},"Logout"))))}}),ImageInput=React.createClass({displayName:"ImageInput",render:function(){return React.createElement("div",{className:"form-group home-inputs"},React.createElement("label",{htmlFor:this.props.slug},this.props.title," "),React.createElement("div",{className:"preview-title"},"Current Image: "),React.createElement("img",{src:"/images/upload/"+this.props.slug+"/600-"+this.props.slug+".jpg",className:"preview thumbnail"}),React.createElement("input",{type:"file",id:this.props.slug,accept:"image/*",onChange:this.props.fileChange}),React.createElement("p",{className:"help-block"},"Choose a new image (Optional)"))}}),AddMenu=React.createClass({displayName:"AddMenu",getInitialState:function(){return{addMenu:MenuStore.getAddMenuForm()}},componentDidMount:function(){MenuStore.bind("change",this.onChange)},componentWillUnmount:function(){MenuStore.unbind("change",this.onChange)},onChange:function(){this.setState({addMenu:MenuStore.getAddMenuForm()})},newMenuChange:function(e){MenuActions.changeAddMenuTitle(e.target.value)},menuDescriptionChange:function(e){MenuActions.changeAddMenuDescription(e.target.value)},onSubmit:function(e){e.preventDefault(),MenuActions.addMenu()},render:function(){return React.createElement("div",{className:"panel panel-default"},React.createElement("h2",{className:"panel-heading"},"Add New Menu"),React.createElement("form",{noValidate:!0,onSubmit:this.onSubmit,className:"panel-body"},React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:"new-menu",className:"control-label"}," New Menu Title: "),React.createElement("input",{type:"text",id:"new-menu",className:"form-control",onChange:this.newMenuChange,value:this.state.addMenu.title})),React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:"new-menu-description",className:"control-label"}," New Menu Description: "),React.createElement("input",{type:"text",id:"new-menu-description",className:"form-control",onChange:this.menuDescriptionChange,value:this.state.addMenu.description})),React.createElement("input",{type:"submit",className:"btn btn-default",disabled:0===this.state.addMenu.title.length,value:"Add New Menu"}),React.createElement("div",{className:"response-messages"},React.createElement("span",{className:this.state.addMenu.menuAdded?"text-success":"hidden"},"Menu was added!"),React.createElement("span",{className:this.state.addMenu.menuAddedError?"text-danger":"hidden"},"There was an error adding the menu. Please make sure the menu name is unique."))))}}),AddMenuItem=React.createClass({displayName:"AddMenuItem",getInitialState:function(){return MenuItemStore.getMenuItemForm()},componentDidMount:function(){MenuItemStore.bind("change",this.onChange),MenuItemActions.loadMenuItems(this.props.menuSlug)},componentWillUnmount:function(){MenuItemStore.unbind("change",this.onChange)},onChange:function(){this.setState(MenuItemStore.getMenuItemForm())},changeTitle:function(e){MenuItemActions.changeAddMenuItemTitle(e.target.value)},changeDescription:function(e){MenuItemActions.changeAddMenuItemDescription(e.target.value)},changePrice:function(e){MenuItemActions.changeAddMenuItemPrice(e.target.value)},addMenuItem:function(e){e.preventDefault(),MenuItemActions.addMenuItem()},render:function(){return React.createElement("div",{className:"panel panel-default"},React.createElement("h2",{className:"panel-heading"},"Add Menu Item"),React.createElement("form",{noValidate:!0,onSubmit:this.addMenuItem,className:"panel-body"},React.createElement("div",{className:"form-group"},React.createElement("label",{className:"control-label",htmlFor:"menu-item-title"},"Item title:"),React.createElement("input",{className:"form-control",type:"text",id:"menu-item-title",value:this.state.title,onChange:this.changeTitle})),React.createElement("div",{className:"form-group"},React.createElement("label",{className:"control-label",htmlFor:"menu-item-description"},"Item description:"),React.createElement("input",{className:"form-control",type:"text",id:"menu-item-description",value:this.state.description,onChange:this.changeDescription})),React.createElement("div",{className:"form-group"},React.createElement("label",{className:"control-label",htmlFor:"menu-item-price"},"Item price:"),React.createElement("input",{className:"form-control",type:"text",id:"menu-item-price",value:this.state.price,onChange:this.changePrice})),React.createElement("input",{type:"submit",className:"btn btn-default",value:"Add Item",disabled:this.state.title.length<1})))}}),EditMenu=React.createClass({displayName:"EditMenu",getInitialState:function(){return MenuStore.getEditMenuForm()},componentDidMount:function(){MenuStore.bind("change",this.onChange),MenuActions.loadEditMenuForm(this.props.menuSlug)},componentWillUnmount:function(){MenuStore.unbind("change",this.onChange)},onChange:function(){this.setState(MenuStore.getEditMenuForm())},changeTitle:function(e){MenuActions.changeEditMenuTitle(e.target.value)},changeDescription:function(e){MenuActions.changeEditMenuDescription(e.target.value)},onSubmit:function(event){event.preventDefault(),MenuActions.submitEditForm()},render:function(){return React.createElement("div",{className:"edit-menu panel panel-default"},React.createElement("h2",{className:"panel-heading"},"Edit Menu"),React.createElement("form",{noValidate:!0,onSubmit:this.onSubmit,className:"panel-body"},React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:"menu-title"},"Menu Title: "),React.createElement("input",{type:"text",className:"form-control",id:"menu-title",onChange:this.changeTitle,value:this.state.title})),React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:"menu-description"},"Menu Description: "),React.createElement("input",{type:"text",className:"form-control",id:"menu-description",onChange:this.changeDescription,value:this.state.description})),React.createElement("input",{type:"submit",className:"btn btn-default",value:"Save changes"})))}}),Menu=React.createClass({displayName:"Menu",render:function(){return React.createElement("div",{className:"menu container"},React.createElement(EditMenu,{menuSlug:this.props.params.menuSlug}),React.createElement(AddMenuItem,{menuSlug:this.props.params.menuSlug}),React.createElement(MenuItems,{menuSlug:this.props.params.menuSlug}))}}),MenuItem=React.createClass({displayName:"MenuItem",onDelete:function(e){MenuItemActions.deleteMenuItem(this.props.item.id)},render:function(){return React.createElement("div",{className:"menu-item list-group-item"},React.createElement("h3",null,this.props.item.title),React.createElement("div",{className:"menu-item__price"},React.createElement("strong",null,"Price: ")," $",this.props.item.price),React.createElement("div",{className:"menu-item__description"},React.createElement("strong",null,"Description: ")," ",this.props.item.description),React.createElement("button",{className:"btn btn-default",onClick:this.onDelete},"Delete this menu item"))}}),MenuItems=React.createClass({displayName:"MenuItems",getInitialState:function(){return{menuItems:MenuItemStore.getMenuItems()}},componentDidMount:function(){MenuItemStore.bind("change",this.onChange)},componentWillUnmount:function(){MenuItemStore.unbind("change",this.onChange)},onChange:function(){this.setState({menuItems:MenuItemStore.getMenuItems()})},formatMenuItems:function(menuItems){return menuItems.map(function(menuItem){return React.createElement(MenuItem,{item:menuItem,key:menuItem.id})})},render:function(){var menuItems=this.formatMenuItems(this.state.menuItems);return React.createElement("div",{className:"menu-items panel panel-default"},React.createElement("h2",{className:"panel-heading"},"Menu Items"),menuItems)}}),Menus=React.createClass({displayName:"Menus",getInitialState:function(){return{currentMenus:[],newMenu:"",menuDescription:"",menuAdded:!1,menuAddError:!1}},render:function(){return React.createElement("div",{className:"container"},React.createElement(MenusListings,null),React.createElement(AddMenu,null))}}),MenusListing=React.createClass({displayName:"MenusListing",onDelete:function(id,event){MenuActions.deleteMenu(id)},render:function(){return React.createElement("li",{className:"menu-listing list-group-item"},React.createElement("div",{className:"menu__title"},React.createElement("strong",null,this.props.menu.title)),React.createElement("div",{className:"menu__description"},this.props.menu.description),React.createElement(Link,{to:"/admin/menus/"+this.props.menu.slug,className:"btn btn-default"},"Edit this menu"),React.createElement("button",{className:"btn btn-default",onClick:this.onDelete.bind(this,this.props.menu.id)},"Delete this menu"))}}),MenusListings=React.createClass({displayName:"MenusListings",getInitialState:function(){return{currentMenus:MenuStore.getMenus()}},componentDidMount:function(){MenuStore.bind("change",this.onChange),MenuActions.loadMenus()},componentWillUnmount:function(){MenuStore.unbind("change",this.onChange)},onChange:function(){this.setState({currentMenus:MenuStore.getMenus()})},formatMenus:function(menus){return menus.map(function(menu){return React.createElement(MenusListing,{key:menu.id,menu:menu})})},render:function(){var menus=this.formatMenus(this.state.currentMenus);return React.createElement("div",{className:"panel panel-default"},React.createElement("h2",{className:"panel-heading"},"Current Menus"),React.createElement("ul",{className:"list-group"},menus))}}),Router=ReactRouter,DefaultRoute=Router.DefaultRoute,Link=Router.Link,Route=Router.Route,RouteHandler=Router.RouteHandler,NotFoundRoute=Router.NotFoundRoute,mountElement=document.getElementById("mount");$.ajaxSetup({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")}});var App=React.createClass({displayName:"App",render:function(){return React.createElement("div",{className:"app-container"},React.createElement("div",{className:"app"},React.createElement(Header,null),React.createElement(RouteHandler,null)))}}),routes=React.createElement(Route,{handler:App},React.createElement(Route,{name:"home",path:"/admin",handler:Home}),React.createElement(Route,{name:"menus",path:"/admin/menus",handler:Menus}),React.createElement(Route,{name:"menu",path:"/admin/menus/:menuSlug",handler:Menu}),React.createElement(Route,{name:"about",path:"/admin/about",handler:About}),React.createElement(Route,{name:"contact",path:"/admin/contact",handler:Contact}),React.createElement(DefaultRoute,{handler:Home}),React.createElement(NotFoundRoute,{handler:Home}));Router.run(routes,Router.HistoryLocation,function(Handler){React.render(React.createElement(Handler,null),mountElement)})},{flux:2,react:198,"react-router":29}]},{},[199]);