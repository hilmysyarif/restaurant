	...
	loadHome: function() {
		...
		$.get('/api/home', function(data) {
			...
			picturefill({
				reevaluate: true, 
				elements: [
					document.getElementById('homeFeaturedOne'),
					document.getElementById('homeFeaturedTwo'),
					document.getElementById('homeFeaturedThree'),
					document.getElementById('homeFeaturedFour')
				]
			});
		})
		.fail(function(data) {
